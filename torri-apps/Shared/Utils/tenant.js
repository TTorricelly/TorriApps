/**
 * Centralized tenant detection utility
 * Single source of truth for tenant identification logic
 */

// Re-export getTenantInfo from existing implementations
// This allows us to use the already-working tenant detection logic
export { getTenantInfo } from '../../Web-admin/Src/Utils/apiHelpers';
