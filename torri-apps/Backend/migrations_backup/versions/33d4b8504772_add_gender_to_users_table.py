"""add_gender_to_users_table

Revision ID: 33d4b8504772
Revises: 9e114511e7ba
Create Date: 2025-06-10 21:15:32.611217
...
revision: str = '33d4b8504772'
down_revision: Union[str, None] = '9e114511e7ba'
...
def upgrade() -> None:
    ...
    sa.Column('hair_type', sa.Enum('LISO', 'ONDULADO', 'CACHEADO', 'CRESPO', name='hairtype'), nullable=True),
