...
app.include_router(professionals_router, prefix=f"{API_V1_PREFIX}/professionals", tags=["Professionals Management (Tenant)"])
app.include_router(stations_router, prefix=f"{API_V1_PREFIX}/stations", tags=["Stations Management (Tenant)"])
app.include_router(settings_router, prefix=f"{API_V1_PREFIX}/settings", tags=["Application Settings (Tenant)"])
app.include_router(company_router, prefix=f"{API_V1_PREFIX}/company", tags=["Company Management (Tenant)"])
